import type { GiteeRepoInfo, GiteeUserInfo } from "@/lib/gitee.types";
import type { GithubRepoInfo, UserInfo } from "@/lib/github.types";
...
interface SyncState {
	...
	setGiteeUserInfo: (giteeUserInfo?: GiteeUserInfo) => void;
